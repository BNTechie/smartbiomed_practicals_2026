...
| Session | Worksheet (fill in the blanks) | Executed (read-only) |
|---|---|---|
...
- **Worksheet** (`practical.ipynb`) — skeleton code with `???` blanks for students to complete.
  Each exercise has a collapsed **Solution** cell to reveal, and short conceptual questions have a
  **👉 Show answer** dropdown.
